...
void TXDescrList::Save( QByteStream& Stream, PDescrList pList)
  ...
  if( pList->m_pDocument == nullptr )
    ...
    RichTextDocument RT;
    RT.SetContent( pList );
    RT.Save( Stream, pList->m_bHasEndLeft );
    pList->m_pDocument = nullptr;
    return;
    }
  pList->m_pDocument->Save( Stream, pList->m_bHasEndLeft );
  }
...
void RichTextDocument::Save( QByteStream& Stream, bool bENDLEFTNotAdded )
  {
